...
var ServerInformation = {
	POIDATA_SERVER: "http://delycomp.com/prueba/siosi.php",
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		var str = poiData[currentPlaceNr].descripcion_lugarES;
        var res = str.replace("Ã¡", "á");
        res = res.replace("Ã©", "é");
        res = res.replace("Ã³", "ó");
        res = res.replace("Ãº", "ú");
        res = res.replace("Ã±", "ñ");
        res = res.replace("Ã", "í");
        poiData[currentPlaceNr].descripcion_lugarES = res
			var singlePoi = {
				"id": poiData[currentPlaceNr].cod_lugar,
				"latitude": parseFloat(poiData[currentPlaceNr].latitud),
				"longitude": parseFloat(poiData[currentPlaceNr].longitud),
				"altitude": parseFloat(poiData[currentPlaceNr].altitude),
				"title": poiData[currentPlaceNr].name_lugar,
				"tipo_lugar": poiData[currentPlaceNr].tipo_lugar,
				"tarifa": poiData[currentPlaceNr].tarifa,
				"departamento": poiData[currentPlaceNr].departamento,
                "Valoracion": poiData[currentPlaceNr].Valoracion,
                "Hratencion": poiData[currentPlaceNr].Hratencion,
				"description": poiData[currentPlaceNr].descripcion_lugarES,
				"descripcion_lugarEN": poiData[currentPlaceNr].descripcion_lugarEN,
				"telefono": poiData[currentPlaceNr].telefono
			};
	...
	*/
	...
	onPoiDetailMoreButtonClicked: function onPoiDetailMoreButtonClickedFn() {
		...
		var markerSelectedJSON = {
            ...
            latitud: currentMarker.poiData.latitude,
            longitud: currentMarker.poiData.longitude,
            title: currentMarker.poiData.title,
            telefono: currentMarker.poiData.telefono,
            tipo_lugar: currentMarker.poiData.tipo_lugar,
            tarifa: currentMarker.poiData.tarifa,
            departamento: currentMarker.poiData.departamento,
            Valoracion: currentMarker.poiData.Valoracion,
            Hratencion: currentMarker.poiData.Hratencion,
            descripcion_lugarEN: currentMarker.poiData.descripcion_lugarEN,
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		$("#poi-detail-description").html(marker.poiData.descripcion_lugarEN);
